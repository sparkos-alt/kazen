...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230924_kazenprojects_c9f7fcad5e877db64846_20230924221039_archive.zip';
        const ARCHIVE_SIZE       = '114333294';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'c9f7fca-24221039';
        const SECONDARY_PACKAGE_HASH = 'fbd2eea-24221039';
        const VERSION            = '1.5.6';
